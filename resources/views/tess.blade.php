...
<html>
	<head>
		...
		<title>Demo Business Consulting 4 | Porto - Responsive HTML5 Template</title>	
		...
		<!-- Favicon -->
		<link rel="shortcut icon" href="assets_porto/img/favicon.ico" type="image/x-icon" />
		<link rel="apple-touch-icon" href="assets_porto/img/apple-touch-icon.png">
		...
		<link rel="stylesheet" href="assets_porto/vendor/owl.carousel/assets/owl.carousel.min.css">
		<link rel="stylesheet" href="assets_porto/vendor/owl.carousel/assets/owl.theme.default.min.css">
		<link rel="stylesheet" href="assets_porto/vendor/magnific-popup/magnific-popup.min.css">

		<!-- Theme CSS -->
		<link rel="stylesheet" href="assets_porto/css/theme.css">
		<link rel="stylesheet" href="assets_porto/css/theme-elements.css">
		<link rel="stylesheet" href="assets_porto/css/theme-blog.css">
		<link rel="stylesheet" href="assets_porto/css/theme-shop.css">

		<!-- Demo CSS -->
		<link rel="stylesheet" href="assets_porto/css/demos/demo-business-consulting-4.css">

		<!-- Skin CSS -->
		<link id="skinCSS" rel="stylesheet" href="assets_porto/css/skins/skin-business-consulting-4.css">

		<!-- Theme Custom CSS -->
		<link rel="stylesheet" href="assets_porto/css/custom.css">

		<!-- Head Libs -->
		<script src="assets_porto/vendor/modernizr/modernizr.min.js"></script>
	...
	<body>
							...
							<div class="header-column">
								<div class="header-row">
									<div class="header-logo">
										<a href="index.html">
											<img alt="Porto" width="123" height="32" src="assets_porto/img/demos/business-consulting-4/logo.png">
										</a>
									</div>
								</div>
							</div>
							...
							<div class="col">
								<div class="row pt-5 mt-5 mb-5 pb-5">
									...
									<div class="col-12 col-lg-6 p-relative text-end">
										...
										<img class="appear-animation img-fluid custom-element-wrapper custom-element-8" data-appear-animation="fadeIn" data-appear-animation-delay="900" src="assets_porto/img/demos/business-consulting-4/generic/generic-1.png" alt="">
										...
										<div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="800">
											<div class="owl-carousel owl-theme stage-margin rounded-nav nav-dark nav-icon-1 nav-size-md nav-position-1" data-plugin-options="{'responsive': {'0': {'items': 1}, '479': {'items': 1}, '768': {'items': 2}, '979': {'items': 2}, '1199': {'items': 2}}, 'margin': 10, 'loop': true, 'nav': true, 'dots': false, 'stagePadding': 40}">
												<div class="overlay overlay-color-primary overlay-show overlay-op-8 rounded overflow-hidden">
													<img alt="" class="assets_porto/img-fluid rounded" src="assets_porto/img/demos/business-consulting-4/generic/generic-2.jpg">
												...
												<div class="overlay overlay-color-dark overlay-show overlay-op-9 rounded overflow-hidden">
													<img alt="" class="assets_porto/img-fluid rounded" src="assets_porto/img/demos/business-consulting-4/generic/generic-3.jpg">
													<a href="#" class="p-absolute z-index-2 top-0 left-0 w-100 h-100 anim-hover-translate-top-5px transition-2ms">
														<span class="p-absolute left-0 bottom-0 text-color-light text-start ms-4 mb-3 ps-2 pb-1">
												...
												<div class="overlay overlay-color-primary overlay-show overlay-op-8 rounded overflow-hidden">
													<img alt="" class="assets_porto/img-fluid rounded" src="assets_porto/img/demos/business-consulting-4/generic/generic-4.jpg">
													<a href="#" class="p-absolute z-index-2 top-0 left-0 w-100 h-100 anim-hover-translate-top-5px transition-2ms">
														<span class="p-absolute left-0 bottom-0 text-color-light text-start ms-4 mb-3 ps-2 pb-1">
															<strong class="text-5 negative-ls-05 font-weight-bold">Why Choose Us</strong>
															<p class="font-weight-medium text-color-light opacity-7 p-relative bottom-4 mb-0">Lorem ipsum dolor sit amet...</p>
												...
												<div class="overlay overlay-color-dark overlay-show overlay-op-9 rounded overflow-hidden">
													<img alt="" class="assets_porto/img-fluid rounded" src="assets_porto/img/demos/business-consulting-4/generic/generic-5.jpg">
													<a href="#" class="p-absolute z-index-2 top-0 left-0 w-100 h-100 anim-hover-translate-top-5px transition-2ms">
														<span class="p-absolute left-0 bottom-0 text-color-light text-start ms-4 mb-3 ps-2 pb-1">
															<strong class="text-5 negative-ls-05 font-weight-bold">Consulting for Growth</strong>
															<p class="font-weight-medium text-color-light opacity-7 p-relative bottom-4 mb-0">Lorem ipsum dolor sit amet...</p>
						...
						<div class="row pt-4 pb-5">
							<div class="col-lg-6 text-center p-relative pt-5">
								...
								<div class="appear-animation custom-element-wrapper custom-element-11 p-relative rotate-r-45" data-appear-animation="fadeIn" data-appear-animation-delay="300">
									<img class="assets_porto/img-fluid" src="assets_porto/img/demos/business-consulting-4/generic/generic-6.jpg" alt="">
								</div>
						...
						<div class="row py-5 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="300">
								...
								<div class="card card-border card-border-top card-border-hover bg-color-light border-0 box-shadow-6 box-shadow-hover anim-hover-translate-top-10px transition-3ms anim-hover-inner-wrapper">
									<div class="card-body p-relative zindex-1 p-5 text-center">
										<div class="anim-hover-inner-translate-top-20px transition-3ms">
											<img width="72" height="73" src="assets_porto/img/demos/business-consulting-4/icons/icon-1.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary'}" />
							...
							<div class="col-md-4 mb-4 mb-md-0">
								<div class="card card-border card-border-top card-border-hover bg-color-light border-0 box-shadow-6 box-shadow-hover anim-hover-translate-top-10px transition-3ms anim-hover-inner-wrapper">
									<div class="card-body p-relative zindex-1 p-5 text-center">
										<div class="anim-hover-inner-translate-top-20px transition-3ms">
											<img width="72" height="73" src="assets_porto/img/demos/business-consulting-4/icons/icon-2.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary'}" />
							...
							<div class="col-md-4">
								<div class="card card-border card-border-top card-border-hover bg-color-light border-0 box-shadow-6 box-shadow-hover anim-hover-translate-top-10px transition-3ms anim-hover-inner-wrapper">
									<div class="card-body p-relative zindex-1 p-5 text-center">
										<div class="anim-hover-inner-translate-top-20px transition-3ms">
											<img width="72" height="73" src="assets_porto/img/demos/business-consulting-4/icons/icon-3.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary'}" />
										...
										<div class="testimonial testimonial-style-3 testimonial-style-3-light">
											...
											<div class="testimonial-author">
												<div class="testimonial-author-thumbnail">
													<img src="assets_porto/img/clients/client-1.jpg" class="assets_porto/img-fluid rounded-circle" alt="">
												</div>
					...
					<div class="container py-5">
						<div class="row align-items-center text-center">
							<div class="col-sm-4 col-lg-2 mb-5 mb-lg-0">
								<img src="assets_porto/img/logos/logo-8.png" alt="" class="assets_porto/img-fluid" style="max-width: 90px;">
							</div>
							<div class="col-sm-4 col-lg-2 mb-5 mb-lg-0">
								<img src="assets_porto/img/logos/logo-9.png" alt="" class="assets_porto/img-fluid" style="max-width: 140px;">
							</div>
							<div class="col-sm-4 col-lg-2 mb-5 mb-lg-0">
								<img src="assets_porto/img/logos/logo-10.png" alt="" class="assets_porto/img-fluid" style="max-width: 140px;">
							</div>
							<div class="col-sm-4 col-lg-2 mb-5 mb-sm-0">
								<img src="assets_porto/img/logos/logo-11.png" alt="" class="assets_porto/img-fluid" style="max-width: 140px;">
							</div>
							<div class="col-sm-4 col-lg-2 mb-5 mb-sm-0">
								<img src="assets_porto/img/logos/logo-12.png" alt="" class="assets_porto/img-fluid" style="max-width: 100px;">
							</div>
							<div class="col-sm-4 col-lg-2">
								<img src="assets_porto/img/logos/logo-13.png" alt="" class="assets_porto/img-fluid" style="max-width: 100px;">
							</div>
						</div>
					</div>
				</section>

				<section class="parallax section section-text-light section-parallax bg-primary m-0" data-plugin-parallax data-plugin-options="{'speed': 1.5}" data-image-src="assets_porto/img/demos/business-consulting-4/parallax/parallax-1.jpg">
					<div class="container py-5">
						<div class="row justify-content-center">
							<div class="col">
								...
								<a href="demo-business-consulting-4-blog-post.html" class="text-decoration-none">
									<div class="card border-0 bg-transparent">
										<div class="card-img-top position-relative overlay overflow-hidden border-radius">
											...
											<img src="assets_porto/img/demos/business-consulting-4/blog/post-thumb-1.jpg" class="assets_porto/img-fluid border-radius" alt="Lorem Ipsum Dolor" />
										</div>
								...
								<a href="demo-business-consulting-4-blog-post.html" class="text-decoration-none">
									<div class="card border-0 bg-transparent">
										<div class="card-img-top position-relative overlay overflow-hidden border-radius">
											...
											<img src="assets_porto/img/demos/business-consulting-4/blog/post-thumb-2.jpg" class="assets_porto/img-fluid border-radius" alt="Lorem Ipsum Dolor" />
										</div>
										<div class="card-body py-4 px-0">
											<span class="d-block text-color-grey font-weight-semibold positive-ls-2 text-2">BY ADMIN</span>
											<h4 class="font-weight-bold text-5 text-color-hover-primary mb-2">Lorem ipsum dolor sit a met, consectetur</h4>
								...
								<a href="demo-business-consulting-4-blog-post.html" class="text-decoration-none">
									<div class="card border-0 bg-transparent">
										<div class="card-img-top position-relative overlay overflow-hidden border-radius">
											...
											<img src="assets_porto/img/demos/business-consulting-4/blog/post-thumb-3.jpg" class="assets_porto/img-fluid border-radius" alt="Lorem Ipsum Dolor" />
										</div>
										<div class="card-body py-4 px-0">
											<span class="d-block text-color-grey font-weight-semibold positive-ls-2 text-2">BY ADMIN</span>
											<h4 class="font-weight-bold text-5 text-color-hover-primary mb-2">Lorem ipsum dolor sit a met, consectetur</h4>
					...
					<div class="row pt-5">
						<div class="col-lg-4">
							<a href="demo-business-consulting-4.html" class="text-decoration-none">
								<img src="assets_porto/img/demos/business-consulting-4/logo-light.png" width="123" height="32" class="assets_porto/img-fluid mb-4" alt="Porto" />
							</a>
		...
		<script src="assets_porto/vendor/jquery.easy-pie-chart/jquery.easypiechart.min.js"></script>
		<script src="assets_porto/vendor/jquery.gmap/jquery.gmap.min.js"></script>
		...
		<script src="assets_porto/vendor/owl.carousel/owl.carousel.min.js"></script>
		...
		<script src="assets_porto/vendor/particles/particles.min.js"></script>

		<!-- Theme Base, Components and Settings -->
		<script src="assets_porto/js/theme.js"></script>

		<!-- Demo -->
		<script src="assets_porto/js/demos/demo-business-consulting-4.js"></script>
